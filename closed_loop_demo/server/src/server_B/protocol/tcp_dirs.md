...
- Actions: TCP 28081 (board -> server request, server -> board response)
- Override by env:
  - `QWEN3_INGEST_PORT` (default `18080`)
  - `QWEN3_ACTIONS_PORT` (default `28081`)
...
- Prefer firewall allowlist for ports 18080/28081.
